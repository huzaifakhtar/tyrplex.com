    ...
    <div className="bg-white shadow-lg rounded-lg p-8 mx-auto dark:bg-gray-800">
      <div className="flex flex-col place-content-between md:flex-row">
        <div className="w-3/5">
          ...
          <button className="bg-red-500 text-white px-6 py-3 rounded-full hover:bg-red-600 transition flex items-center justify-center w-full md:w-auto dark:bg-red-600 dark:hover:bg-red-700">
